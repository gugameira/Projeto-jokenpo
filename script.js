...
const humanoJogada = document.querySelector('#humano-jogada')
...
const playhuman = (humanChoice) => {
  ...
  humanoJogada.textContent = `${GAME_OPTIONS[humanChoice.toUpperCase()].nome} ${GAME_OPTIONS[humanChoice.toUpperCase()].emoji}`
...
const playmachine = () => {
  const choices = [
    GAME_OPTIONS.PEDRA.nome.toLowerCase(),
    GAME_OPTIONS.PAPEL.nome.toLowerCase(),
    GAME_OPTIONS.TESOURA.nome.toLowerCase()
  ]
